...
class PresetDefaults {
  ...
  const PresetDefaults({this.steps, this.width, this.height});
}
...
class PresetCatalog {
  ...
  static const Map<String, PresetDefaults> _defaultsByPreset = {
    ...
    'StableDiffusion3Medium': PresetDefaults(steps: 30, width: 1024, height: 1024),
    'StableDiffusion3_5Medium': PresetDefaults(steps: 40, width: 1024, height: 1024),
    ...
    'Flux1Schnell': PresetDefaults(steps: 4, width: 1024, height: 1024),
    'Flux1Mini': PresetDefaults(steps: 20, width: 1024, height: 1024),
    'JuggernautXL11': PresetDefaults(steps: 20, width: 1024, height: 1024),
    'Chroma': PresetDefaults(steps: 20, width: 512, height: 512),
    'NitroSDRealism': PresetDefaults(steps: 1, width: 1024, height: 1024),
    'NitroSDVibrant': PresetDefaults(steps: 1, width: 1024, height: 1024),
    'DiffInstructStar': PresetDefaults(steps: 1, width: 1024, height: 1024),
    'ChromaRadiance': PresetDefaults(steps: 20, width: 512, height: 512),
    'SSD1B': PresetDefaults(steps: 20, width: 1024, height: 1024),
    'Flux2Dev': PresetDefaults(steps: 20, width: 512, height: 512),
    'ZImageTurbo': PresetDefaults(steps: 9, width: 512, height: 1024),
    'QwenImage': PresetDefaults(steps: 20, width: 1024, height: 1024),
    'OvisImage': PresetDefaults(steps: 20, width: 512, height: 512),
    'DreamShaperXL2_1Turbo': PresetDefaults(steps: 6, width: 1024, height: 1024),
    'TwinFlowZImageTurboExp': PresetDefaults(steps: 3, width: 512, height: 1024),
    'SDXS512DreamShaper': PresetDefaults(steps: 1, width: 512, height: 512),
    'Flux2Klein4B': PresetDefaults(steps: 4, width: 1024, height: 1024),
    ...
    'Anima': PresetDefaults(steps: 30, width: 1024, height: 1024),
    'Anima2': PresetDefaults(steps: 30, width: 1024, height: 1024),
    'ErnieImage': PresetDefaults(steps: 20, width: 1024, height: 1024),
    'ErnieImageTurbo': PresetDefaults(steps: 8, width: 1024, height: 1024),
    ...
    'LongCatImage': PresetDefaults(steps: 20, width: 512, height: 512),
